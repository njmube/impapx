			...
			<div class="span9">
				...
				<dl>
					...
					<g:if test="${marcaInstance?.dateCreated}">
						<dt><g:message code="marca.dateCreated.label" default="Date Created" /></dt>
						
							<dd><g:formatDate date="${marcaInstance?.dateCreated}" /></dd>
						
					</g:if>
				
					<g:if test="${marcaInstance?.lastUpdated}">
						<dt><g:message code="marca.lastUpdated.label" default="Last Updated" /></dt>
						
							<dd><g:formatDate date="${marcaInstance?.lastUpdated}" /></dd>
