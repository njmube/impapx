...
<body>
	<div class="container">
		<ul class="nav nav-tabs" >
			<li class="active">
				<g:link controller="facturaDeImportacion" action="list">
				<i class="icon-list "></i>
					Facturas de importación
				</g:link>
			</li>
			<li >
				<g:link controller="gastosDeImportacion" action="list"><i class="icon-list"></i>
		...
		<div class="row">
			<div class="span12">
				...
				<div class="pagination">
					<bootstrap:paginate total="${facturaDeImportacionInstanceTotal}" />
				</div>
			</div>
		</div>
	</div>
